...
int main(int argc, char *argv[])
{
	 ...
	 while (stop!=1)
	 {
		 ...
		 data = write(wP, &message1, sizeof(message1)); //writing on the second pipe
	...
	printf("g2 File descriptors closed\n");
	fflush(stdout);
	logFile("g2 closes file descriptors: ");
	exit(0);
